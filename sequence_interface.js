...
Object.defineProperty(Sequence.prototype, "head", {
  get: function(){
    return this.collection[0];
  }
});

Object.defineProperty(Sequence.prototype, "iterate", {
  get: function(times){
...
sequence = new Sequence(["boogie", "blame"]);
console.log(sequence.head);
console.log(sequence.iterate(3));
